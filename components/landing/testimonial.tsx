...
const TestimonialCard = ({
    ...
    const { t } = useTranslation();
    const name = t(`landing.testimonials.items.${testimonial.key}.name`);
    const designation = t(`landing.testimonials.items.${testimonial.key}.designation`);
    const text = t(`landing.testimonials.items.${testimonial.key}.text`);
        ...
        <div className="mb-8 bg-accent rounded-xl py-8 px-6 sm:py-6">
            <div className="flex items-center justify-between gap-20">
                <div
                    ...
                    <div
                        className="absolute top-1/4 right-0 translate-x-1/2 h-12 w-12 bg-primary rounded-full flex items-center justify-center">
                        <svg
                            width="102"
                            height="102"
                            viewBox="0 0 102 102"
