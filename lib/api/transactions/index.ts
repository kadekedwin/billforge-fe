...
export async function getTransactions(params?: TransactionQueryParams): Promise<ApiResponse<Transaction[]>> {
...
export async function createTransaction(data: CreateTransactionRequest): Promise<ApiResponse<Transaction>> {
  return apiClient.post<Transaction>("/api/transactions", data);
}

export async function updateTransaction(id: string | number, data: UpdateTransactionRequest): Promise<ApiResponse<Transaction>> {
  return apiClient.put<Transaction>(`/api/transactions/${id}`, data);
}

export async function deleteTransaction(id: string | number): Promise<ApiResponse<MessageResponse>> {
